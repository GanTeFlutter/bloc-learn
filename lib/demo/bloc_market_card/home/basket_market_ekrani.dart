    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            BlocListener<BasketappBloc, BasketappState>(listener: (context, state) {
              ...
              builder: (context, state) {
                ...
                } else if (state is BasketListEmit) {
                  // BasketListEmit state'inde sadece sepetin öğelerini gösteriyoruz
                  if (state.basketList.isEmpty) {
                    return const Text('Sepetinizde ürün bulunmamaktadır.');
                  }
                  return SizedBox(
